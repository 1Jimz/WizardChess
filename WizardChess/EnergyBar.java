...
public class EnergyBar extends Actor {
    private int e;         
    private int maxE;     // max energy
    private int barWidth;  
    private int barHeight; 
    private Color fullEnergy; // color when energy is high
    private Color mediumEnergy; // color when energy is medium
    private Color lowEnergy;  // color when energy is low
