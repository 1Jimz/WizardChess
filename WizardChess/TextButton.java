...
public class TextButton extends Widget
{
    ...
    public TextButton (String text, int fontSize){
        ...
        //sets the font
        TextFont = new Font ("calib",fontSize);
        this.text = text;
     ...
     */
    public TextButton (String text, int fontSize, int txtR, int txtG, int txtB, int highlightR, int highlightG, int highlightB){
        //sets the colours
     ...
     * @param fontSize          The font size, as an integer
     */
    public TextButton (String text, String fontName, int fontSize){
        //sets the colours
        textColour = new Color(98,98,98);
        highlightColour = new Color(158,158,159);
        //sets the font
     ...
     * @param highlightB        The intensity of blue in the highlight colour of the button. The B value in RGB
     */
    public TextButton (String text,  String fontName, int fontSize, int txtR, int txtG, int txtB, int highlightR, int highlightG, int highlightB){
        //sets the colours
        textColour = new Color(txtR,txtG,txtB);
        highlightColour = new Color(highlightR,highlightG,highlightB);
        //sets the font
